...
public class MongoTokenStore implements TokenStore {
    ...
    public OAuth2Authentication readAuthentication(String token) {
        ...
        if(accessToken != null) {
            try {
                return deserialize(accessToken.getAuthentication());
    ...
    public void storeAccessToken(OAuth2AccessToken token, OAuth2Authentication authentication) {
        byte[] bufferedToken = serialize(token);
        byte[] bufferedAuthentication = serialize(authentication);
    ...
    public OAuth2AccessToken readAccessToken(String tokenId) {
        ...
        if(accessToken != null) {
            try {
                return deserialize(accessToken.getToken());
            } catch (IllegalArgumentException e) {
    ...
    public void storeRefreshToken(OAuth2RefreshToken refreshToken, OAuth2Authentication authentication) {
        ...
        byte[] bufferedRefreshToken = serialize(refreshToken);
        byte[] bufferedAuthentication = serialize(authentication);
    ...
    public OAuth2RefreshToken readRefreshToken(String tokenId) {
        ...
        if (refreshToken != null) {
            try {
                return deserialize(refreshToken.getToken());
            } catch (IllegalArgumentException e) {
    ...
    public OAuth2Authentication readAuthenticationForRefreshToken(OAuth2RefreshToken token) {
        ...
        if (refreshToken != null) {
            try {
                return deserialize(refreshToken.getAuthentication());
            } catch (IllegalArgumentException e) {
    ...
    private Function<AccessToken, OAuth2AccessToken> toOAuth2AccessToken() {
        return token -> deserialize(token.getToken());
    }
