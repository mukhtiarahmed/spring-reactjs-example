...
public final class AuthHelper {
     ...
     */
    public static ApiResponse buildErrorResponse(Throwable e, HttpStatus httpStatus, String message) {
        ApiResponse apiResponse = new ApiResponse();
        apiResponse.setMessage(message);
        apiResponse.setStatus(new Meta(httpStatus));
        return apiResponse;
    }
     ...
     * @return the error response
     */
    public static ApiResponse buildErrorResponse(HttpStatus httpStatus, String message) {
        ApiResponse apiResponse = new ApiResponse();
        apiResponse.setMessage(message);
        apiResponse.setStatus(new Meta(httpStatus));
        return apiResponse;
     ...
     * @throws IOException
     */
    public static void sendJsonErrorResponse(Throwable e, HttpStatus httpStatus, HttpServletResponse response) throws IOException {
        ...
        try {
            errorMessage =  MAPPER.writeValueAsString(apiResponse);
        } catch (JsonProcessingException e1) {
